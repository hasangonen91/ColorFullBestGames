...
import { RootStackParamList, Screen } from '../Navigations/RootStackParamList';
...
interface SplashScreenProps {
  // Define any props if needed, e.g., navigation
}
...
const SplashScreen: React.FC<SplashScreenProps> = () => {
  ...
  const handleGetStarted = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      navigation.navigate(Screen.MainScreen); // 'MainScreen' yerine kendi ana ekran adınızı kullanın.
    }, 1500);
  };
